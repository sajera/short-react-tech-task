...
import { useControllerData } from '../services/controller';
import { controller as appController } from '../controller';
...
export default memo(() => {
    ...
    const { user } = useControllerData(appController);
    // NOTE show message to suggest proceed as detected user
    useEffect(() => {
        toastr.message('Authorization detected', 'Proceed as:', { component: UserProceed });
